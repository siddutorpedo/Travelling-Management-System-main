...
export const bookPackage = async (req, res) => {
  try {
    ...
    return res.status(500).send({
      success: false,
      message: "Internal Server Error during package booking",
      error: error.message,
    });
  }
};
...
export const getCurrentBookings = async (req, res) => {
  try {
    ...
    return res.status(500).send({
      success: false,
      message: "Internal Server Error during fetching current bookings",
      error: error.message,
    });
  }
};
...
export const getAllBookings = async (req, res) => {
  try {
    ...
    return res.status(500).send({
      success: false,
      message: "Internal Server Error during fetching all bookings",
      error: error.message,
    });
  }
};
...
export const getUserCurrentBookings = async (req, res) => {
  try {
    ...
    return res.status(500).send({
      success: false,
      message: "Internal Server Error during fetching user bookings",
      error: error.message,
    });
  }
};
...
export const getAllUserBookings = async (req, res) => {
  try {
    ...
    return res.status(500).send({
      success: false,
      message: "Internal Server Error during fetching all user bookings",
      error: error.message,
    });
  }
};
...
export const deleteBookingHistory = async (req, res) => {
  try {
    ...
    return res.status(500).send({
      success: false,
      message: "Internal Server Error during booking history deletion",
      error: error.message,
    });
  }
};
